...
public class SlipsAndGuesses {
	// looping for each question in the course
		...
		for(int Q = 0; Q < Calibration.total_Q - 1 ; Q++){
			...
			Calibration.slip[Q] = SlipNumerator.divide(SlipDenominator) ;
			Calibration.guess[Q] = GuessNumerator.divide(GuessDenominator) ;
		}
		}
}
